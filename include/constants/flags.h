...
//Daycare lady Togepi Egg
#define FLAG_DAYCARE_LADY                   0x31A
...
#define FLAG_SYS_EXP_ALL (SYS_FLAGS + 0x100)
#define FLAG_WORLD_MAP_POKEMON_LEAGUE_LORELEIS_ROOM (SYS_FLAGS + 0xAF) //was commented out
// #define FLAG_SYS_BEAT_LORELEI (SYS_FLAGS + 0x4C) //new
