...
#define MOVE_FLAMINGEXIT 0x3E0
#define MOVE_NIGHTBRAND 0x3E1
...
#define LAST_MOVE_INDEX     MOVE_NIGHTBRAND
#define MOVES_COUNT        (MOVE_NIGHTBRAND + 1)
#define NON_Z_MOVE_COUNT   (MOVE_GLACIALLANCE + 1)
// #define NON_Z_MOVE_COUNT   (MOVE_PSYCHICNOISE + 1)